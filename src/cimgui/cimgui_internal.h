...
typedef struct ImGuiNavItemData_t ImGuiNavItemData;                          // Result of a gamepad/keyboard directional navigation move query result
...
typedef struct ImVector_unsigned_char_t
{
    int            Size;
    int            Capacity;
    unsigned char* Data;
} ImVector_unsigned_char;
typedef struct ImVector_ImGuiWindowStackData_t
{
    int                   Size;
    int                   Capacity;
    ImGuiWindowStackData* Data;
} ImVector_ImGuiWindowStackData;
typedef struct ImVector_ImGuiWindowPtr_t
{
    int           Size;
    int           Capacity;
    ImGuiWindow** Data;
} ImVector_ImGuiWindowPtr;
typedef struct ImVector_ImGuiViewportPPtr_t
{
    int              Size;
    int              Capacity;
    ImGuiViewportP** Data;
} ImVector_ImGuiViewportPPtr;
typedef struct ImVector_ImGuiTreeNodeStackData_t
{
    int                     Size;
    int                     Capacity;
    ImGuiTreeNodeStackData* Data;
} ImVector_ImGuiTreeNodeStackData;
typedef struct ImVector_ImGuiTableTempData_t
{
    int                 Size;
    int                 Capacity;
    ImGuiTableTempData* Data;
} ImVector_ImGuiTableTempData;
typedef struct ImVector_ImGuiTableInstanceData_t
{
    int                     Size;
    int                     Capacity;
    ImGuiTableInstanceData* Data;
} ImVector_ImGuiTableInstanceData;
typedef struct ImVector_ImGuiTableHeaderData_t
{
    int                   Size;
    int                   Capacity;
    ImGuiTableHeaderData* Data;
} ImVector_ImGuiTableHeaderData;
typedef struct ImVector_ImGuiTableColumnSortSpecs_t
{
    int                        Size;
    int                        Capacity;
    ImGuiTableColumnSortSpecs* Data;
} ImVector_ImGuiTableColumnSortSpecs;
typedef struct ImVector_ImGuiTable_t
{
    int         Size;
    int         Capacity;
    ImGuiTable* Data;
} ImVector_ImGuiTable;
typedef struct ImVector_ImGuiTabItem_t
{
    int           Size;
    int           Capacity;
    ImGuiTabItem* Data;
} ImVector_ImGuiTabItem;
typedef struct ImVector_ImGuiTabBar_t
{
    int          Size;
    int          Capacity;
    ImGuiTabBar* Data;
} ImVector_ImGuiTabBar;
typedef struct ImVector_ImGuiStyleMod_t
{
    int            Size;
    int            Capacity;
    ImGuiStyleMod* Data;
} ImVector_ImGuiStyleMod;
typedef struct ImVector_ImGuiStackLevelInfo_t
{
    int                  Size;
    int                  Capacity;
    ImGuiStackLevelInfo* Data;
} ImVector_ImGuiStackLevelInfo;
typedef struct ImVector_ImGuiShrinkWidthItem_t
{
    int                   Size;
    int                   Capacity;
    ImGuiShrinkWidthItem* Data;
} ImVector_ImGuiShrinkWidthItem;
typedef struct ImVector_ImGuiSettingsHandler_t
{
    int                   Size;
    int                   Capacity;
    ImGuiSettingsHandler* Data;
} ImVector_ImGuiSettingsHandler;
typedef struct ImVector_ImGuiPtrOrIndex_t
{
    int              Size;
    int              Capacity;
    ImGuiPtrOrIndex* Data;
} ImVector_ImGuiPtrOrIndex;
typedef struct ImVector_ImGuiPopupData_t
{
    int             Size;
    int             Capacity;
    ImGuiPopupData* Data;
} ImVector_ImGuiPopupData;
typedef struct ImVector_ImGuiOldColumns_t
{
    int              Size;
    int              Capacity;
    ImGuiOldColumns* Data;
} ImVector_ImGuiOldColumns;
typedef struct ImVector_ImGuiOldColumnData_t
{
    int                 Size;
    int                 Capacity;
    ImGuiOldColumnData* Data;
} ImVector_ImGuiOldColumnData;
typedef struct ImVector_ImGuiMultiSelectTempData_t
{
    int                       Size;
    int                       Capacity;
...
typedef struct ImVector_ImGuiListClipperData_t
{
    int                   Size;
    int                   Capacity;
    ImGuiListClipperData* Data;
} ImVector_ImGuiListClipperData;
typedef struct ImVector_ImGuiKeyRoutingData_t
{
    int                  Size;
    int                  Capacity;
...
typedef struct ImVector_ImGuiInputEvent_t
{
    int              Size;
    int              Capacity;
    ImGuiInputEvent* Data;
} ImVector_ImGuiInputEvent;
typedef struct ImVector_ImGuiID_t
{
    int      Size;
    int      Capacity;
    ImGuiID* Data;
} ImVector_ImGuiID;
typedef struct ImVector_ImGuiGroupData_t
{
    int             Size;
    int             Capacity;
    ImGuiGroupData* Data;
} ImVector_ImGuiGroupData;
typedef struct ImVector_ImGuiFocusScopeData_t
{
    int                  Size;
    int                  Capacity;
    ImGuiFocusScopeData* Data;
} ImVector_ImGuiFocusScopeData;
typedef struct ImVector_ImGuiDockRequest_t
{
    int               Size;
    int               Capacity;
    ImGuiDockRequest* Data;
} ImVector_ImGuiDockRequest;
typedef struct ImVector_ImGuiDockNodeSettings_t
{
    int                    Size;
    int                    Capacity;
    ImGuiDockNodeSettings* Data;
} ImVector_ImGuiDockNodeSettings;
typedef struct ImVector_ImGuiContextHook_t
{
    int               Size;
    int               Capacity;
    ImGuiContextHook* Data;
} ImVector_ImGuiContextHook;
typedef struct ImVector_ImGuiColorMod_t
{
    int            Size;
    int            Capacity;
    ImGuiColorMod* Data;
} ImVector_ImGuiColorMod;
typedef struct ImVector_const_charPtr_t
{
    int          Size;
    int          Capacity;
    const char** Data;
} ImVector_const_charPtr;
typedef struct ImVector_int_t
{
    int  Size;
    int  Capacity;
    int* Data;
...
typedef struct ImGuiInputTextState_t
{
    ...
    ImVector_char       TextA;                 // main UTF8 buffer.
    ImVector_char       InitialTextA;          // value to revert to when pressing Escape = backup of end-user buffer at the time of focus (in UTF-8, unaltered)
...
typedef struct ImGuiStackSizes_t
{
    short SizeOfIDStack;
...
// Viewports
CIMGUI_API void                        ImGui_TranslateWindowsInViewport(ImGuiViewportP* viewport, ImVec2 old_pos, ImVec2 new_pos);
...
CIMGUI_API void ImGui_NavRestoreHighlightAfterMove(void);
...
CIMGUI_API void        ImGui_RenderNavHighlight(ImRect bb, ImGuiID id);                                                                                                  // Implied flags = ImGuiNavHighlightFlags_None
CIMGUI_API void        ImGui_RenderNavHighlightEx(ImRect bb, ImGuiID id, ImGuiNavHighlightFlags flags /* = ImGuiNavHighlightFlags_None */);                              // Navigation highlight
...
CIMGUI_API void ImGui_ErrorCheckEndWindowRecover(ImGuiErrorLogCallback log_callback);                                      // Implied user_data = NULL
CIMGUI_API void ImGui_ErrorCheckEndWindowRecoverEx(ImGuiErrorLogCallback log_callback, void* user_data /* = NULL */);
...
// Obsolete functions
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API void ImGui_SetItemUsingMouseWheel(void);                                            // Changed in 1.89
CIMGUI_API bool ImGui_TreeNodeBehaviorIsOpen(ImGuiID id, ImGuiTreeNodeFlags flags /* = 0 */);  // Renamed in 1.89
